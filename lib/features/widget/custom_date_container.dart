          ...
          return Padding(
            ...
            child: Text(months[index],
                  style: yourTextStyle.copyWith(
                    color: index == 5 ?kPrimaryBlue : Colors.black.withOpacity(0.41)
                  ),
                  ),
          );
         } ),
            ...
            itemBuilder: (context, index) {
              return Stack(
                children:[
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(days[index],style: TextStyle(
                                  ...
                                  color:index == 3 ?Colors.white : Colors.black.withOpacity(0.41)
                                ),),
                                Text(numbers[index],style: TextStyle(
                                  fontSize: 17.7.sp,
                  ...
                  if (index == 3) // Only show the Positioned container on the fourth index
                    Positioned(
                      top: 3,
                      left: 21,
                      child: Container(
